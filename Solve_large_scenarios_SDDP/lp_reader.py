...
class set(object):
    def __init__(self, mat_data,fourth1,fourth2,fourth3):
        ...
        for i in range(self.first['numScenarios']):
            for j in range(self.second[i]['numScenarios']):
                for k in range(self.third[i][j]['numScenarios']):
                    self.fourth[i][j][k] = {
                        'obj': fourth1['fourth'][0, 0]['obj'][i, j, k][0].astype(float),
                        'lb': fourth3['fourth'][0, 0]['lb'][i, j, k][0].astype(float),
                        'ub': fourth3['fourth'][0, 0]['ub'][i, j, k][0].astype(float),
                        'rhs': fourth3['fourth'][0, 0]['rhs'][i, j, k][0].astype(float),
                        'A': fourth2['fourth'][0, 0]['A'][i, j, k].astype(float),
                        'B': fourth2['fourth'][0, 0]['B'][i, j, k].astype(float)}
